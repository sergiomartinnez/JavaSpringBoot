...
public interface UserRepository extends PagingAndSortingRepository<User, Long> {
    ...
    @Query("Select new com.fundamentalsplatzi.springboot.fundamentals.dto.UserDto(u.id, u.name, u.birthDate)" + " From User u " + " where u.birthDate=:parametroFecha " + " and u.email=:parametroEmail")
